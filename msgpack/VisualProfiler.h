...
#ifndef VISUALPROFILERTIMER_HPP
#define VISUALPROFILERTIMER_HPP
...
public:
    ...
    VisualProfilerTimer(const std::string& name) : m_result({ name, 0, 0, 0 }), m_stopped(false) {
    ...
    void stop() {
        ...
        VisualProfiler::Instance().writeProfile(m_result);
